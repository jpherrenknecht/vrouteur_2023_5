...
GR = np.zeros((len(iprev), 721, 1440), dtype=complex)    # initialise le np array de complexes qui recoit les donnees  
#
for indexprev in range(len(iprev)):  # recuperation des fichiers de 0 a 384 h
    ...
    #commande = ["/home/jp/wgrib2/grib2/wgrib2/wgrib2", nom_fichier_local, "-set_grib_max_bits", "7", "-new_grid", nom_fichier_local7b]
...
indice384=indexprev
sauvegardeGrib(filename384,GR,tig384,indice384,tig384+13200)



# lecture d'une valeur   
print()
print('tests de valeurs')
print(GR[0,0,0])
print(GR[1,1,1])
print(GR[1,10,10])
print(GR[208,10,10])
